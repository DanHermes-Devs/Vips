...
<div class="popmail">
	<div class="popmailcont">
	<h3>Para terminar con tu registro,<br> ingresa tu correo electrónico</h3>
	 <form  id="formmailfb" class="formlogin" onsubmit="return false"  enctype="multipart/form-data" method="post">
					<div id="respuesta3">
						...
						<div class="inputs logininputs">
							...
							<input class="input inputfbmail" type="text" id="correofb" name="correofb" placeholder="correo@email.com" required>
						...
						<div>
							...
							<a class="boton top"  id="btnfbmail">Terminar registro</a>
...
//      easing:'easeOutExpo'
		...
		$('#btnfbmail').click(function(event){
			...
			var mailvalidfb = validateEmail(emailvalfb);	
		 
		
			if (emailvalfb == '')
			{
			$("#respuesta3").html("<div class='errormsg'>Ingresa tu email</div>");
			$("#correofb").addClass("errorinput");
			
			}

			else if ( mailvalidfb == false)
			{
