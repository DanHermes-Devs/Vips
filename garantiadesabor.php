...
if ($detect->isMobile()) {
    header('Location: garantiadesabor-m');
    exit(0);
}
?>
...
<img src="/img/2019/garantia/Landing_GDS-Desktop-Fondo.png" class="imgmain" width="100%;">
	<div class="gif">
	...
	<div class="platillo pla5 ">
		...
		<div class="carouseldesayunos">
				...
				<div>
					<img src="/img/2019/garantia/Garantia1.png">
				</div>
				
				<div>
					<img src="/img/2019/garantia/G2.png">
				</div>
				
				<div>
					<img src="/img/2019/garantia/Garantia3.png">
				</div>
