...
if($nueva == 1){
	...
	header("Location: domicilio-rappi-2");
...
if ($detect->isMobile()) {
	header('Location: domicilio-rappi-m?n='.$_GET['n']);
	exit(0);
}
	...
	<div class="containerparallax" id="parallaxlogin">
		...
		<a href="#" id="work" class="parallaxTilt_hover">
			...
			<div id="loginpanel">
				...
				<p class="redtit" googl="true" style="color:#f5a623;">Para llevarlo hasta tu ubicación necesitamos unos datos</p>
    ...
    $('#btnregd2').click(function(event){
	  ...
	  $("#respuestad2").hide();
...

		{
			...
			$("body").animate({ scrollTop: $("#topreg").offset().top });
