...
if ($detect->isMobile()) {
    header('Location: /selvamagica-registro-m');
    exit(0);
}
...
if( isset($_SESSION['uservips'])!="" ){
	...
	header("Location: /selvamagica-bienvenido");
}
...
main {
	...
	display: inline-block;
		...
		* {
		...
		#tab2_content .input::placeholder {
			color: #7f4f1c!important;
		}
...
#tab2_content p.phidden {
	color: #feec90!important;
}
...
#tab2_content .switchcont {
	display: inline-block;
	padding: 0 5%;
}
#tab2_content .pformtoggle {
	color: #feec90;
	font-size: .8em;
	font-family: "Program",sans-serif;
}
...
#tab2_content  #btnreg img {
	width: 100%;
	max-width: 150px;
}
#tab2_content  #formlogin {
	max-width: 300px;
	display: inline-block;
	width: 100%;
}
	...
	<div id="tab2_content" id="panellogin">
			...
			<div id="loginpanel">
				...
				<div>
					...
					<form  id="formlogin" class="formlogin" onsubmit="return false"  enctype="multipart/form-data" method="post" autocomplete="false">
					...
					<div id="respuesta2"></div>
						...
						<label class="yellowlabel">Correo</label>
						...
						<div class="inputs logininputs">
							<label class="yellowlabel">Contraseña</label>
						...
						<div>
							...
							<a class="boton top"  id="btnlogin"><img src="/img/2019/juego/INICIA.png"></a>
			...
			<div id="regpanel" style="display:none;">
				...
				<a class="simple-ajax-popup mfp-with-anim  blanco btnfb1 reggoogle" href="/avisogoogle.php?page=<?php echo $page; ?>" data-effect="mfp-zoom-out" id="google" ></a>
					...
					<div class="formulario form" id="topreg" autocomplete="false">
			...
			<form id="formreg" class="formreg" onsubmit="return false"  enctype="multipart/form-data" method="post">
				...
				<div class="inputs">
					...
					<label class="yellowlabel">Nombre</label>
				...
				<div class="inputs">
					<label class="yellowlabel">Apellidos</label>
				...
				<div class="switchcont" >
					...
					<div class="switchcont" >
						...
						<div style="float: left; width: 100%; margin-top: 0px; z-index: 1; position: relative; height: auto; overflow: hidden; float: left;">
						<div class="g-recaptcha" data-theme="light" data-sitekey="6LdgS20UAAAAAOYAzOxw83A05x-fKz6OJS3Ojpch" style="z-index: 1; transform:scale(.8); float:left;"></div>
						</div>
						...
						<p class="requiredtext">* Campo requerido</p>
							...
							<a class="boton top boton-registro"  id="btnreg"><img src="/img/2019/juego/registrate_grande.png"></a>
...
.leftcont {
	float: left;
	width: 50%;
	background: url(/img/2019/juego/pantalla_leon.png);
	height: 100vh;
