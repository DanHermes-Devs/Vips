...
.inforight .col-md-6 li {
  ...
  <main>
    <div class="row">
      ...
      <div class="main">
              <div class="col-md-7">
                  <img src="/img/2019/comidadeldia/Hero-pic.png" class="banner desktop">
                  <img src="/img/2019/comidadeldia/Hero-pic-mobile.png" class="banner mobile">
                  <br>
                  <br>
                ...
                <div class="col-md-6">
                  <ul>
                    ...
                    <li>Refresco <span class="cals">(360 mL)</span></li>
              ...
              <div class="col-md-5 inforight">
                ...
                <div class="col-md-6">
                  ...
                  <ul>
                    <li>Sopa o crema del día <span class="cals">(270 mL / 113 Cal)</span></li>
                    <li>Consomé con arroz y pollo <span class="cals">(270 mL)</span></li>
                  ...
                  <div class="carouselplatos">
                    <div>
                      ...
                      <ul>
                        <li class="platillo nuevo">
                          <p class="titplato">Tortitas de cerdo en salsa de tres chiles <span>(2 pzas / 501 Cal)</span></p>
                          <p class="descplato">Acompañados de arroz blanco.</p>
                        </li>
                        <li class="platillo nuevo">
                          <p class="titplato">Doraditas de papa con chorizo <span>(3 pzas / 587 Cal)</span></p>
                          <p class="descplato">Servidas con lechuga, crema, queso y salsa martajada.</p>
                        </li>
                    ...
                    <div>
                      ...
                      <ul>
                        ...
                        <li class="platillo nuevo">
                          <p class="titplato">Escalopas de res a la mexicana <span>(10 g / 267 Cal)</span></p>
                          <p class="descplato">Acompañadas de ensalada de nopales.</p>
                        </li>
                        <li class="platillo nuevo">
                          <p class="titplato">Alambre de pollo <span>(300 g / 440 Cal)</span></p>
                          <p class="descplato">Preparado con chile poblando, cebolla, champiñones, jitomate y tocino. Acompañado de frijoles refritos.</p>
                        </li>
                        <li class="platillo nuevo">
                          <p class="titplato">Puntas de res en salsa verde con nopales <span>(230 g / 470 Cal)</span></p>
                          <p class="descplato">Acompañadas de arroz blanco y frijoles refritos.</p>
                        </li>
                      </ul>
                    </div>
                    <div>
