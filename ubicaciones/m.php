...
.controls {
	...
	border: .70vw dashed #979797 border-right:none;
...
.uber, .rappi, .sdelantal{width:0px; padding: 0 1%; display:inline-block;}
...
.gm-style {
	...
	<?php include('../lateral.php');?>
		...
		<li class="taxonomy-term centerlocation tooltip-right estado tselected" edo="ubicacion" data-tooltip="Ir a mi ubicación" id="centerlocation" alt="Mi ubicación"></li>
		...
		<li class="taxonomy-term estado" id="edomex" edo="Estado de México">Estado de México</li>
			...
			<ul id="stores"data-list-stores >
				...
				<a class="no-store" style="display: none" href="#">Recargar</a>
				...
				<li class="store" data-store-template  style="display: none">
				  ...
				  <div class="number hidden" style="display:none;" data-store-attr="number"></div>
			...
			<strong><span class="distance" data-store-attr="distance-miles"></span><h2 class="title"  style="text-transform:uppercase;" data-store-attr='{"content":"name"}'></h2></strong>
				...
				<p  class="horario hidden" data-store-attr='{"content":"horario"}'>
				...
				<div data-store-attr="botonmaps" style="left: 0; width: 50%; float: left;"> </div>
				<a data-store-link-to-map class="verenmapa">Ver en mapa ></a>
				
				
				<!--<a class="btndeliver link2" style="position: absolute; left: 45%; margin-top: -70px; width: 50%; padding: 0; font-weight:bold; display:none; text-transform:uppercase;" href="tel:01 800 900 8477"  target="_blank"  data-store-attr='{"content":"delivery"}'>
			...
			<div style="display: none" data-store-infowindow-template>
				...
				<span data-store-link-to-map data-store-attr="name" class="titlemap"></span><br>
		...
		<!--
			...
			<a class="taxonomy-term centerlocation tooltip" data-tooltip="Ir a mi ubicación" edo="ubicacion" id="centerlocation" alt="Mi ubicación"></a>
