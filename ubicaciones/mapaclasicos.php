...
.gm-style .gm-style-iw-t::after{
	    border-top: 11px solid #fffadd!important;
}
.gm-style-iw * {
...
centerlocation tooltip-right estado tselected centerlocation" edo="ubicacion" data-tooltip="Ir a mi ubicación" id="centerlocation" alt="Mi ubicación"></li>	
		...
		<li class="taxonomy-term estado" id="edomex" edo="Estado de México">Estado de México</li>
			...
			<div data-store-attr="plato"></div>

			<br>

				<span  data-store-attr="name" style="
	font-weight: bold;
	position: relative;
	padding-left: 0;
	font-size: 1.1em;
...
"></span><br><br>
				...
				<span  data-store-attr="vips" style="
	font-weight: bold;
	position: relative;
...
.imgbtnsrh {
	...
	/* display: inline-block; */
		...
		<script src="jquery.storelctrclasicos.js"></script>
		...
		<script>
			...
			var filter="<?php echo $decodeq; ?>";
				...
				var file = 'storesclasicos.php?filter='+filter+'&edo='+edo;

				

			    $.get(file, { lat: <?php echo $latq; ?>, lng: <?php echo $lngq; ?> }, 'json').success(callback);
