...
centerlocation tooltip-down estado tselected centerlocation" edo="ubicacion" data-tooltip="Ir a mi ubicación" id="centerlocation" alt="Mi ubicación"></li>	
		...
		<li class="taxonomy-term estado" id="edomex" edo="Estado de México">Estado de México</li>
			...
			<h2 class="titleub2">ENCUENTRA TU VIPS MÁS CERCANO</h2>

	<h3 class="titleub3">Visita tu Vips favorito y obtén los nuevos modelos del juguete más popular del momento.</h3>
		...
		<!--
			...
			<a class=" centerlocation tooltip-right" data-tooltip="Ir a mi ubicación" edo="ubicacion" id="centerlocation2" alt="Mi ubicación"></a>
