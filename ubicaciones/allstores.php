...
$db_host = "localhost";
$db_user = "storelocatoruser";
$db_pass = "storelocator";
$db_name = "storelocator2";
...
$sql = "SELECT id, name, addressresume, address, zip, city, state, country, url, phone, latitude, longitude,
