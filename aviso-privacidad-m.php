...
if ($detect->isMobile()) {
  ...
  header('Location: /aviso-privacidad');
...
<img class="aviso" src="img/aviso_privacidad.png">
...
<div class="ayuda">
	...
	<h1>AVISO DE PRIVACIDAD </h1><h1 style="margin-left: 9%">INTEGRAL WEB VIPS<sup>®</sup></h1>
