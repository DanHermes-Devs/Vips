...
if ($detect->isMobile()) {
  ...
  header('Location: /responsabilidad-social');
...
.ayuda h1{font-size: 1.5em; color: #ED7124;font-family:'Program', sans-serif; text-align:center;}
...
<img class="aviso" src="img/respbanner.jpg">
