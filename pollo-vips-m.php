...
if ($detect->isMobile()) {
  ...
  header('Location: /pollo-vips-preview');
...
<img src="/img/2019/pollo/mobile/Landing_mobile_pollo-Fondo-min.png" class="imgmain" width="100%;">
	<div class="gif">

	<div class="platillo pla1">
	
					<img class="yellowcircle2  wow fadeInRight"  src="img/2019/pollo/Precio_Cuarto-Pollo-min.png">
					<img src="img/2019/pollo/Cuarto_PolloRostizado-min.png" class="pollo pollo2  wow fadeInLeft">
					
		
			
					<img class="yellowcircle1  wow fadeInLeft"  src="img/2019/pollo/Precio_Medio-Pollo-min.png">
					<img src="img/2019/pollo/Medio_Pollo_R-min.png" class="pollo pollo1  wow fadeInRigt">
					


	</div>
	
		<div class="platillo pla3  wow fadeInLeft " data-wow-offset="200" data-wow-delay=".5s">

	<div class="carousel1">
		
				<div>
					<img src="img/2019/pollo/mobile/Guarnicion1-min.png">
					
				</div>
				<div>
					<img src="img/2019/pollo/mobile/Guarnicion2-min.png">
					
				</div>
				<div>
					<img src="img/2019/pollo/mobile/Guarnicion3-min.png">
