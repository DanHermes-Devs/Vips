...
if( /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ) {
    ...
    window.location = "/reydelaenchilada-m"+hash1;
}
</script>
...
.marco {
	background: url(img/reyenchilada/recuadro.svg);
...
<img src="img/reyenchilada/Fondo.gif" class="imgmain" width="100%;" style="display:none;">
	...
	<div id="contentpop" style="display:none;">
		...
		<img src="img/reyenchilada/_FR_Enchiladas Copy.svg" class="corona wow  fadeInUp">
		...
		<h3 class="wow  fadeInUp">Conviértete en un miembro de la realeza y llévate premios</h3>

			<h4 class="wow  fadeInUp">El reino del sabor necesita líderes, ¿tienes lo que se necesita para conquistarlo?</h4>
			<h5 class="wow  fadeInUp">Hemos decidido emprender una batalla para descubrir quién es el verdadero elegido por los Dioses de la enchilada. <span tyle="color: #eac47d">La lucha empieza este 19 de enero.</span>
</h5>
		...
		<div class="pasos ">
			...
			<h3 class="wow  fadeInUp">Es súper sencillo:</h3>
		...
		<h4 class="wow  fadeInUp">Esta es la última Familia Real de la Enchilada, el grupo de nuestros invitados que más disfrutó de las enchiladas de Vips
		...
		<div class="brownpleca" style="margin-top: -5px; display:none;">
			<h2  class="wow  fadeInUp">La batalla comienza de nuevo cada dos semanas, tendrás la oportunidad de proteger tu título… o serás desterrado.</h2>
		</div>
		...
		<div class="img enchilada" style="display:none;"><img id="enchilada2" src="img/reyenchilada/_Enchiladas-de-Mole.png"></div>
			<div class="textenchilada" style="display:none;">
			<h3>Cuéntanos una historia con nuestras enchiladas y ¡recibe un regalo!</h3>
...
<?php }    else{ ?>
	...
	<a  style="cursor:pointer;" class="openpoplogin brownbtn wow  fadeInUp">Inicia sesión para dejar tu historia.</a>
<?php }?>
...
<a href="entrada?id=21"><div class="bubblecont" style="float: right;">
...
<a href="entrada?id=22"><div class="bubblecont" style="float: right;">
...
<a><div class="bubblecont" style="float: right;">
...
<div class="bubble bubble2">“…“¿Como se llama este guiso?” preguntó, “no lo sé señor, pongámosle un nombre”. “¡Enchiladas se llamarán! ¡redoblen los tambores! que resuenen las fanfarrias que ¡un nuevo platillo ha nacido!”…”</div>
		...
		<!-- InstaWidget -->
<a href="https://instawidget.net/v/tag/ReyDeLaEnchilada" id="link-525274b062fa789b7ca522c938a71bba9cf18126246176bb17ba353a4d8dcc44">#ReyDeLaEnchilada</a>
<script src="https://instawidget.net/js/instawidget.js?u=525274b062fa789b7ca522c938a71bba9cf18126246176bb17ba353a4d8dcc44&width=850px"></script>
...
<div class="comments redescont">
	<form  id="formcomment" onsubmit="return false"  enctype="multipart/form-data" method="post">
		...
		<h2 style="color:#4c2812; padding: 2% 0; padding-bottom: 0; margin-bottom: 0em; font-size: 200%;">Cuéntanos una historia con nuestras enchiladas</h2>
		<p style="margin-top: .5em; color:#692e2e">En Vips hemos acompañado a la familia mexicana por más de 50 años, y queremos conocer tu experiencia con nosotros y nuestras tradicionales enchiladas. Mándanos la tuya y si es seleccionada podrás verla en nuestro sitio, en redes sociales y recibirás un monedero electrónico de $150 para disfrutar en Vips. </p>
...
<?php }    else{ ?>
	...
	<a href="/cuenta" class="boton">Inicia sesión para dejar tu historia</a>
<?php }?>
</div>
...
$( window ).on( "load", function() {
  ...
  var waypointn=new Waypoint({element:document.getElementById('enchilada'),handler:function(direction){$(".enchilada").addClass("rotate");}})
});
