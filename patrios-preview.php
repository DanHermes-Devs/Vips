		...
		<div class="col-md-12">	 
			<div class="main">
				...
				<div class="desayunos">
					...
					<div class="textodesayunos"><p>Incluyen: Un jugo <span>(300mL)</span> o una orden de fruta <span>(150g)</span> y café americano <span>(rellenable)</span> o un té de sobre</p></div>
				...
				<div class="titulocomidas"><h2>Incluyen una sopa del día <span>(270mL)</span> y una bebida <span>(360 mL / refresco o naranjada o limonada o agua de sabor) </span> No incluye refrescos en lata.</h2></div>
				...
				<div class="postres">
					<div class="pleca1">
						...
						<div class="texto1">
							<img class="logonew" src="/img/2019/patrios/Logo-NUEVO-min.png">
							<p class="titleplato">Crepas en salsa nogada</p>
