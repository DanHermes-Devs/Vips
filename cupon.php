...
if(strlen($promoid)<2 || strlen($promo)<2){
  ...
  $query = "INSERT INTO log_descargas_cupones(id_usuario, codigo_cupon, nombre_cupon, fecha, ip, browser, source) VALUES('$userid', '$code','$nombrecupon', '$texto_finish', '$ip', '$agent', '$source')";
