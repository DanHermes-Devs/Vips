...
if($numfilas1 >1){
	$linkdomicilio ='';
	$classdomicilio ='linkdomicilio';



}
else{
	$linkdomicilio ='href="/domicilio"';
	$classdomicilio ='';
...
<div id="site-wrapper">
		...
		<div class="vipsmenu">
			...
			<ul>
				...
				<a <?php echo $linkdomicilio;?> id="linkdomicilio" class="<?php echo $classdomicilio;?> linkmenu-m"><li class="vmenuitem" data-div="#domiciliohome">
				...
				<a href="/promociones" class="linkmenu-m"><li class="vmenuitem" data-div="#beneficioshome">
