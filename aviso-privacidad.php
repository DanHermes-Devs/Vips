...
if ($detect->isMobile()) {
    ...
    header('Location: aviso-privacidad-m.php');
...
.resptext p{font-size: .95em;}
	...
	<img style="width:100%;     float: left;" src="img/banne_avisopriv.jpg">

	<div class="resptext">

	

<p style=" font-family: 'Program', sans-serif; font-size:1.2em"><b>AVISO DE PRIVACIDAD INTEGRAL WEB VIPS<sup>®</sup></b></p>
