...
if( isset($_SESSION['uservips'])!="" ){
	...
	header("Location: /domicilio-rappi-m");
}
...
.loginpanel {
	...
	.logininputs .input{width: 100%;float:none;}
...
<div id="tab2_content" id="panellogin">
	<p class="titpr">Regístrate o inicia sesión para hacer tu pedido con</p>

					<div class="textagregadores">

		<div class="agregador rappi">
		 <img src="/img/logorappi.png" style="width: 60%; transform: translateY(25%);" />
...
<div class="loginpanel">
			...
			<div id="loginpanel">
				...
				<p class="redtit" style="display:none;">¿Antojo?<br> Inicia sesión y disfruta el sabor de Vips</p>
				...
				<div>
					...
					<div class="aligncenter" style="float: left; width: 100%;">
						...
						<a  href="/fbconfig?page=domicilio-rappi" id="fb" ></a>
						<a  href="/logingoogle.php?page=domicilio-rappi2" id="google" ></a>
			...
			<form id="formregd" class="formregd" onsubmit="return false"  enctype="multipart/form-data" method="post">
				...
				<div class="switchcont" >
					...
					<div class="switchcont" >
						...
						<div style="float: none; width: 100%; margin-top: 0px; padding: 0%; overflow: hidden; text-align: center; display: inline-block;;">
						...
						<p class="requiredtext">* Campo requerido<br><br></p>
				...
				<a class="simple-ajax-popup mfp-with-anim  blanco btnfb1" href="/avisofb.php?page=domicilio-rappi" data-effect="mfp-zoom-out" id="fb" ></a>
				<a class="simple-ajax-popup mfp-with-anim  blanco btnfb1" href="/avisogoogle.php?page=domicilio-rappi2" data-effect="mfp-zoom-out" id="google" ></a>
				</div>
 ...
 error = true;
	...
	if (error == false){
        ...
        $.ajax({
            ...
            url : "registron2019.php?page=domicilio-rappi",
...

	{
        ...
        $.ajax({
            ...
            url : "login.php?page=domicilio-rappi",
