				...
				<div class="aligncenter">
					<div style=" position: relative; float: left;width: 100%;">
						<div class="aligncenter textcontd">
							<h2 style="font-size: 16px; margin: 20px 0;">Estás a un paso de disfutar el sabor de Vips</h2>
...
<div id="small-dialog3" class="zoom-anim-dialog mfp-hide">
	...
	<h3>Agrega tu C.P. para que podamos localizar a tu servicio a domicilio favorito </h3>
