...
?>
			...
			<div class="carouselbanners">
				...
				<div>
					<a href="/redescubreelsabor"><img src="/img/2019/bgslide.png" data-lazy="/img/banners/mainstream-mobile.png" onclick="promoViewedHome('Redescubre el sabor de Vips');">	</a>
				</div>
				
				<div>
					<a href="https://vips.com.mx/cupones#20Descuento"><img src="/img/2019/bgslide.png" data-lazy="/img/2019/banners/Banner_cupon20.png" onclick="promoViewedHome('Cupón 20% Descuento');">	</a>
				</div>
				...
				<!--<div>
					<a href="/domicilio"><img src="/img/2019/bgslide.png" data-lazy="/img/2019/banners/Carrusel_mobile_agregadores_mayo-junio2-min.png" onclick="promoViewedHome('Promociones Agregadores');">	</a>
				</div>-->
				
				<div>
					<a href="/noches-de-antojo"><img src="/img/2019/bgslide.png" data-lazy="/img/2019/banners/BannerCarruselMobileNochesDeAntojo.png" onclick="promoViewedHome('Noches de antojo');"> </a>	
				</div>
				...
				<div>
					<a href="/desayunos-79"><img src="/img/2019/bgslide.png" data-lazy="/img/2019/banners/Desayunos_79 _Carrusel.png" onclick="promoViewedHome('Desayunos $79');">	</a>
				</div>
    ...
    <div class="tab_container">
      <div id="tab1" class="tab_content">
        <div class="scrolling-wrapper">
			...
			<div class="card" style="margin-left: 2vh; <?php echo $hidelogged;?>">	
				<a href="/cuenta-m">
				<div>
		  ...
		  <div class="card">			<a class="boxhref" href="/cupones-m">
			...
			<span class="top"></span>
				...
				<img src="/img/2019/Promociones2.svg" class="sectionicon" style="width:30%;">
    ...
    <span class="left"></span>
      ...
      <div id="tab2" class="tab_content">
       <div class="promoslist">
			...
			<div class="promo"><a href="/especiales-de-temporada-m"><img src="<?php echo $bannerm; ?>" onclick="promoViewedHome('Especiales de temporada');"></a></div>
			...
			<div class="promo"><a href="/desayunos-79"><img src="/img/2019/banners/Desayunos_79 _Mobile.png" onclick="promoViewedHome('Desayunos $79');"></a></div>
			<div class="promo"><a href="/comida-del-dia"><img src="/img/2019/banners/Banner_mobile_comida_del_dia_Junio-min.png" onclick="promoViewedHome('Comida del día');"></a></div>
			<div class="promo"><a href="/menu-infantil-disney"><img src="/img/2019/banners/AdicionalSpyroloco.png" onclick="promoViewedHome('Menú infantil Disney');"></a></div>
			...
			<div class="promo"><a href="/noches-de-antojo"><img src="/img/2019/banners/Banner_noches_antojo_mobile.png" onclick="promoViewedHome('Noches de antojo');"></a></div>
