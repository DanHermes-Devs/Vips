...
Registra tu ticket y participa para GANAR una de las tres cenas, regalos sorpresa e increíbles premios.
          ...
          <div class="row">
            <div class="col-12 col-sm-6 text-center">
              <a href="login" class="btn_login"><img class="grow" src="images/boton-login_1.png" alt="Login"></a>
            </div>
            <div class="col-12 col-sm-6 text-center">
              <a href="registro" class="btn_registro"><img class="grow" src="images/boton-registrarse.png" alt="Registrarse"></a>
            </div>
          </div>
        </section>
        <!-- END MAIN CONTENT  -->
