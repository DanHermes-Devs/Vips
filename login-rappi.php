...
if( isset($_SESSION['uservips'])!="" ){
	...
	header("Location: /domicilio-rappi");
}
...
<div id="tab2_content" id="panellogin" data-hour = "<?php echo  $h;?>">
	...
	<div class="containerparallax" id="parallaxlogin">
		...
		Regístrate o inicia sesión para hacer tu pedido con
			...
			<div id="loginpanel">
				...
				<div>
					...
					<div class="aligncenter">
						...
						<a  href="/fbconfig.php?page=domicilio-rappi" id="fb" ></a>
