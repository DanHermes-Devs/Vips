 ...
 <ul class="flip-items">
		...
		<li class="clase">
			...
			<p class="p texto">Celebra tu cumpleaños con nosotros y <span style="color:#f29100;"> recibe un regalo especial</span>.</p>
				...
				<div>
					...
					<div class="aligncenter" style="float: left; width: 100%;">
						...
						<a  href="/fbconfig?page=<?php echo $page; ?>" id="fb" ></a>
						<a  href="/logingoogle.php?page=<?php echo $page; ?>" id="google" ></a>
			...
			<div id="regpanel" style="display:none;">
				...
				<p class="redtit">Regístrate<br><span style="font-size:11px;">Tus visitas te dan descuentos y ahora también puntos</span></p>
		...
		<li class="clase">
			...
			<form id="formreg" class="formreg" onsubmit="return false"  enctype="multipart/form-data" method="post">
				...
				<div class="switchcont" >
					...
					<div class="aligncenter" style="float: left; width: 100%;">
					<p class="orfbd" id="orfb" style="width: 100%; float: left;">O regístrate con<br></p>
				<a class="simple-ajax-popup mfp-with-anim  blanco btnfb1" href="/avisofb.php" data-effect="mfp-zoom-out" id="fb" ></a>
				<a class="simple-ajax-popup mfp-with-anim  blanco btnfb1" href="/avisogoogle.php" data-effect="mfp-zoom-out" id="google" ></a>
				</div>
